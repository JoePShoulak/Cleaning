...
Shader "CleanMask"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float lerpResult10_g1 = lerp( 0.0 , 1000.0 , frac( ( sin( dotResult4_g1 ) * 43758.55 ) ));
			float2 temp_cast_0 = (lerpResult10_g1).xx;
			float2 uv_TexCoord20 = i.uv_texcoord + temp_cast_0;
			float simplePerlin2D12 = snoise( uv_TexCoord20*3.0 );
...
Node;AmplifyShaderEditor.FunctionNode;32;-1645,-289.5;Inherit;False;Random Range;-1;;1;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;1000;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C3ABB7B2D4AE31B4827D932BBB84B032560BE623